class Copy
  ...
  #   self.title().==(another_book.title()).&(self.book_author().==(another_book.book_author())).&(self.id().==(another_movie.id()))
  # end
  #
  ...
  #   @id = self.id()
  #   DB.exec("UPDATE copies SET title = '#{@title}', '#{@book_author}' WHERE id = #{@id};")
  # end
  #
